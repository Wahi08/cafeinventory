...
<div class="container-fluid">
    <form action="" id="stockin-form">
        ...
        <div class="form-group">
            ...
            <input type="number" step="any" name="quantity" id="quantity" class="form-control form-control-sm rounded-0 text-right" value="<?= isset($quantity) ? $quantity : '' ?>" min="<?= $min_quantity ?>" max="<?= $max_quantity ?>" required>
        </div>
        <div class="form-group">
