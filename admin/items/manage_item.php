		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="number" name="min_quantity" id="min_quantity" class="form-control form-control-sm rounded-0" value="<?php echo isset($min_quantity) ? $min_quantity : ''; ?>" required/>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="max_quantity" class="control-label">Max Quantity</label>
					<input type="number" name="max_quantity" id="max_quantity" class="form-control form-control-sm rounded-0" value="<?php echo isset($max_quantity) ? $max_quantity : ''; ?>" required/>
				</div>
			</div>
		</div>
		<div class="form-group">
