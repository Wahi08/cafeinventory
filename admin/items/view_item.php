...
<div class="container-fluid">
	<dl>
		...
		<dt class="text-muted">Min Quantity</dt>
		<dd class="pl-4"><?= isset($min_quantity) ? $min_quantity : "" ?></dd>
		<dt class="text-muted">Max Quantity</dt>
		<dd class="pl-4"><?= isset($max_quantity) ? $max_quantity : "" ?></dd>
