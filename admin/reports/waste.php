        ...
        <div class="card rounded-0 mb-2 shadow">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="waste-table">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>Category</th>
...
<script>
    ...
    function updateTotalQuantity() {
        var currentTotal = 0;
        $('#waste-table tbody tr').each(function () {
            var quantity = parseInt($(this).find('td:last').text());
            if (!isNaN(quantity)) {
                currentTotal += quantity;
            }
        });
        $('#waste-table tfoot tr:last-child th:last-child').text(currentTotal);
    }
    ...
    $('#filter-form').submit(function (e) {
        ...
        window.location = './?page=reports/waste&' + formData;
    });
