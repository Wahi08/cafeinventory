        ...
        <div class="container-fluid">
            <table class="table table-hover table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $qry = $conn->query("SELECT id, date_updated, IFNULL(avatar, '') as avatar, fullname, username, type FROM users WHERE id != '{$_settings->userdata('id')}' ORDER BY fullname");
                    ...
                    while($row = $qry->fetch_assoc()):
                        ...
                        <tr>
                            ...
                            <td class="text-center">
								<?php
								if ($row['avatar']) {
									$avatar = 'data:image/jpeg;base64,' . base64_encode($row['avatar']);
								} else {
									$avatar = 'uploads/avatars/3.png'; // Replace with your placeholder image or default image URL
								}
								?>
								<img src="<?php echo $avatar; ?>" alt="" class="img-thumbnail rounded-circle user-avatar">
							</td>
